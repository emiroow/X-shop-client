      ...
      <Slider {...settings}>
        <div>
          <Image
            ...
            width={366}
            height={366}
            src={require(`../../assets/Images/products/p-1.webp`)}
          />
        </div>
        <div>
          <Image
            ...
            width={366}
            height={366}
            src={require(`../../assets/Images/products/p-2.webp`)}
          />
        </div>
        <div>
          <Image
            ...
            width={366}
            height={366}
            src={require(`../../assets/Images/products/p-3.webp`)}
          />
        </div>
        <div>
          <Image
            ...
            width={366}
            height={366}
            src={require(`../../assets/Images/products/p-4.webp`)}
          />
        </div>
      </Slider>
    </div>
